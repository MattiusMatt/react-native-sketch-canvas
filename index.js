        ...
        <TouchableOpacity
            ...
            onPress={() => {
                if (this.state.color === item.color) {
                    const index = this.props.alphlaValues.indexOf(
                        this.state.alpha
                    );
                    if (this._alphaStep < 0) {
                        this._alphaStep = index === 0 ? 1 : -1;
                        this.setState({
                            alpha: this.props.alphlaValues[
                                index + this._alphaStep
                            ],
                        });
                    } else {
                        this._alphaStep =
                            index === this.props.alphlaValues.length - 1
                                ? -1
                                : 1;
                        this.setState({
                            alpha: this.props.alphlaValues[
        ...
        return (
            <View style={this.props.containerStyle}>
                ...
                <SketchCanvas
                    ...
                    pixArtMode={this.props.pixArtMode}
                />
                <View style={{ flexDirection: "row" }}>
                    <FlatList
